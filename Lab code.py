...
def opening_DIA_files(path='/home/diastudent1/Workspace_DG/'):
    runs=['run0/','run1/','run2/','run3/','run4/','run5/']
    ...
    return stats_dfs,config_dfs
stats_dfs,config_dfs=opening_DIA_files()
